...
const Courses: React.FC = () => {
  return (
    <section className={`max-w-7xl mx-auto px-4 py-16 ${roboto.className}`}>
      ...
      <section className="max-w-7xl mx-auto px-4 py-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[24px]">
          {categories.map((course, index) => (
            <div key={index} className="bg-[#F7F7F7] p-4">
              ...
              <div className="flex justify-between items-center mb-2 px-5 gap-8">
                <span className="text-[14px] font-medium text-[#000000]">{course.category}</span>
                <span className="text-[14px] font-bold text-[#000000]">⭐ {course.rating.toFixed(1)}</span>
              </div>
